...
class User_profileTestClass(TestCase):
    def setUp(self):
        ...
        self.user = User_profile(name = 'Levi', id_number = 78426824, neighbourhood = self.neighbourhood, post = "We are haveing a meeting at 10pm", email = "mugalalevi21@gmail.com", pub_date = '2018-05-06')
        self.user.save_User()
...
class BusinessTestClass(TestCase):
    def setUp(self):
        ...
        self.neighbourhood = Neighbourhood(name = "Westlands")
        self.neighbourhood.save()
        self.business1 = Business(business_name = 'KFC', user = self.user, neighbourhood = self.neighbourhood, business_email = "KFc@gmail.com")
