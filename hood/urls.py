...
urlpatterns = [
    ...
    url(r'^accounts/business_profile/', views.register_business, name = 'register_business'),
    url(r'^accounts/my_profile/', views.my_profile, name = 'my_profile'),
    url(r'^accounts/hood_details/(?P<neighbourhood_id>\d+)', views.hood_details, name = 'hood_details'),
